...
export const getAlbumPage = createAsyncThunk(
  "album/getAlbumPage",
  async (arg, thunkAPI) => {
    try {
...
export const createAlbumPage = createAsyncThunk(
  "album/createAlbumPage",
  async (arg, thunkAPI) => {
    try {
...
export const updateAlbumPage = createAsyncThunk(
  "album/updateAlbumPage",
  async (arg, thunkAPI) => {
    try {
...
const albumSlice = createSlice({
  ...
  reducers: {
    ...
    updateSelected: (state, action) => {
      ...
      state.selectedImages = currentSelectedList.toSpliced(
        index,
        1,
        action.payload
      );
    ...
    removeSelected: (state, action) => {
      const currentSelectedList = current(state).selectedImages;
      state.selectedImages = currentSelectedList.filter(
